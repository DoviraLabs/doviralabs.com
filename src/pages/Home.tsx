...
export function Home() {
  return <>
    ...
    <section className="section container about-grid" id="about">
      ...
      <article className="founder-card"><div className="founder-avatar" aria-hidden="true"><span className="founder-initials">DS</span></div><div className="founder-info"><p className="eyebrow" style={{fontSize:"11px",fontWeight:700,letterSpacing:".1em",color:"#27466f",marginBottom:"12px"}}>BEHIND THE PRODUCTS</p><h3>Danish Sheikh</h3><p className="founder-role"><strong>Founder &amp; Developer</strong>, Dovira Labs</p><p className="muted">I lead Dovira Labs with a practical approach shaped by business, systems, and technology. My background in business operations helps me understand real problems, while software development gives me the tools to turn them into useful digital products.</p></div></article>
    </section>
    <ContactCTA/>
  </>;
}
