...
export function Home() {
  return <>
    ...
    <section className="section container about-grid" id="about">
      ...
      <article className="founder-card"><div className="founder-avatar" aria-hidden="true"><span className="founder-initials">DS</span></div><div className="founder-info"><p className="eyebrow founder-kicker">BEHIND THE PRODUCTS</p><h3>Danish Sheikh</h3><p className="founder-role"><strong>Founder &amp; Developer</strong>, Dovira Labs</p><p className="muted">I lead Dovira Labs with a practical approach shaped by business, systems, and technology. My web journey reaches back to the early 2010s, and today I continue learning by building useful digital products.</p><Link className="text-link" to="/founder">View founder story <Icon name="arrow" size={17}/></Link></div></article>
    </section>
    <ContactCTA/>
  </>;
}
